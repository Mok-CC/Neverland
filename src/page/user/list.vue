            ...
            <el-table-column label="操作" width="180" align="center">
                <template #default="scope">
                    ...
                    <div v-else>
                        ...
                        <el-popconfirm title="是否确认删除该记录？" confirm-button-text="确认" 
...
import { getUserList, updateUserStatus, createUser, deleteUser, updateUser } from '@/api/user'
