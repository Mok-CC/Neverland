<template>
    <div v-loading="loading" class="bg-white p-4 rounded">
        <el-form :model="form" label-width="160px">
            <h5 class="bg-gray-100 p-3 rounder mb-5">基础设置</h5>
            ...
            <h5 class="bg-gray-100 p-3 rounder mb-5">返佣设置</h5>
            ...
            <h5 class="bg-gray-100 p-3 rounder mb-5">结算设置</h5>
            ...
            <el-form-item label="佣金到账方式" >
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1">佣金到账方式支持线下转账和微信零钱自动转账，手动转账更安全，自动转账更方便 关闭：分销员自己购买商品没有返佣）</small>
                </div>
            </el-form-item>
