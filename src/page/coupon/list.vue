        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="操作" width="180" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm  v-if="scope.row.statusText !== '领取中'" title="是否确认删除该优惠券？" confirm-button-text="确认" 
                    ...
                    <el-popconfirm v-if="scope.row.statusText === '领取中'" title="是否要失效该优惠券？" confirm-button-text="确认" 
        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                ...
                <el-form-item label="发行量" prop="total">
                    <el-input-number v-model="form.total" label="发行量"
                        :min="0" :max="10000">
                    </el-input-number>
                    
                </el-form-item>
                <el-form-item label="最低使用价格" prop="min_price">
                    <el-input v-model="form.min_price" placeholder="最低使用价格"></el-input>
                </el-form-item>
...
<style scoped>
.active{
    @apply border-rose-200 bg-rose-200 text-red-400
}
.inactive{
